...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'Tenue Metropolitan Division', value = 'tenu_lspd' },
		{ label = 'Tenue Gang Task Force', value = 'tenu_ma' },
		{ label = 'Tenue de Cérémonie', value = 'tenu_cer' },
		...
		{ label = _U('giletjau'), value = 'giletjau' },
	}
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'tenu_cer' or
			...
			data.current.value == 'giletjau' or
...
function OpenVehicleSpawnerMenu(type, station, part, partNum)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle', {
		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('concess:retrieveJobVehicles', function(jobVehicles)
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									TriggerServerEvent('concess:setJobVehicleState', data2.current.vehicleProps.plate, false)
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop', {
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'vehicle_shop_confirm', {
			...
			if data2.current.value == 'yes' then
				local newPlate = exports['concess']:GeneratePlate()
...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {			
			...
			{label = '🎒 Menu Equipement >', value = 'lspd_equipement'},					
			{label = '🧾 Menu Citoyen >', value = 'citizen_interaction'},
			{label = '🔭 Menu Radar >', value = 'rd_mobile'},
			{label = '💳 Menu Licence >', value = 'menu_licence'},				
			{label = '🚘 Menu Véhicule >', value = 'vehicle_interaction'},	
			{label = '💲 Donner une Amende >', value = 'ammende'},			
