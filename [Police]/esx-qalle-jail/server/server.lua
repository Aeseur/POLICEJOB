			...
			if jailTime ~= nil then
				...
				if args[3] ~= nil then
					GetRPName(jailPlayer, function(Firstname, Lastname)
						TriggerClientEvent('chat:addMessage', -1, { args = { "JUGE",  Firstname .. " " .. Lastname .. " a été emprisonné pour : " .. args[3] }, color = { 249, 166, 0 } })
					end)
				end
			else
...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	GetRPName(targetSrc, function(Firstname, Lastname)
		TriggerClientEvent('chat:addMessage', -1, { args = { "JUGE",  Firstname .. " " .. Lastname .. " a été emprisonné pour " .. jailReason }, color = { 249, 166, 0 } })
	end)
...
AddEventHandler("esx-qalle-jail:unJailPlayer", function(targetIdentifier)
	...
	TriggerClientEvent("esx:showNotification", src, xPlayer.name .. " est libre !")
end)
